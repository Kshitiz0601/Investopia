...
public class companyLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText username = findViewById(R.id.gstin);
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatabaseReference reference  = FirebaseDatabase.getInstance().getReference("Company Details");
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()){
                            ...
                            if(Objects.equals(passwordFromDB,userPassword)){
                                username.setError(null);
                                Intent intent = new Intent(companyLogin.this,companyMain.class);
                                intent.putExtra("GSTIN",userUsername);
